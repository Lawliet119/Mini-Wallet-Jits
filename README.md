...
- Ví có checksum để phát hiện sửa số dư ngoài engine, kèm balance snapshot `availableBalance`, `holdBalance`, `settledBalance`.
- Ledger ghi `Transaction` và `PocketEntry` double-entry trong Mongo transaction.
